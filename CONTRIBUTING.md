...
Thank you for considering contributing to enative! Take a look at [the roadmap] to get an idea of the current state of the library.
...
The general advice for new contributors is to share your ideas with the community. You can open a discussion or an issue on our [GitHub repository]. This is a very important step. It helps to coordinate work, get on the same page, and start building trust. Remember that [Code is the Easy Part] and also [The Hard Parts of Open Source]!
...
[GitHub repository]: https://github.com/ecowestern/enative/issues
