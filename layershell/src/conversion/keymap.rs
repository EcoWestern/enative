...
pub fn key(key: layershellev::keyboard::Key) -> enative_core::keyboard::Key {
    use enative_core::keyboard;
    use enative_core::keyboard::key::Named;
    ...
    match key {
        ...
        layershellev::keyboard::Key::Named(named_key) => keyboard::Key::Named(match named_key {
            ...
            _ => return enative_core::keyboard::Key::Unidentified,
        }),
        _ => enative_core::keyboard::Key::Unidentified,
    }
}

pub fn modifiers(modifiers: ModifiersState) -> enative_core::keyboard::Modifiers {
    use enative_core::keyboard;
...
) -> enative_core::keyboard::key::Physical {
    use enative_core::keyboard;
    match physical_key {
...
) -> Option<enative_core::keyboard::key::Code> {
    use enative_core::keyboard;
...
) -> enative_core::keyboard::key::NativeCode {
    use enative_core::keyboard;
