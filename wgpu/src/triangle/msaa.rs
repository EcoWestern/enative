...
impl Pipeline {
    pub fn new(
        ...
        let constant_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            label: Some("enative_wgpu::triangle:msaa uniforms layout"),
            entries: &[
        ...
        let texture_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            label: Some("enative_wgpu::triangle::msaa texture layout"),
        ...
        let layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("enative_wgpu::triangle::msaa pipeline layout"),
            bind_group_layouts: &[&constant_layout, &texture_layout],
            immediate_size: 0,
        });

        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("enative_wgpu triangle blit_shader"),
        ...
        let pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            label: Some("enative_wgpu::triangle::msaa pipeline"),
            layout: Some(&layout),
...
impl Targets {
    pub fn new(
        ...
        let attachment = device.create_texture(&wgpu::TextureDescriptor {
            label: Some("enative_wgpu::triangle::msaa attachment"),
            size: extent,
            mip_level_count: 1,
            sample_count,
        ...
        let resolve = device.create_texture(&wgpu::TextureDescriptor {
            label: Some("enative_wgpu::triangle::msaa resolve target"),
            size: extent,
            mip_level_count: 1,
            sample_count: 1,
            dimension: wgpu::TextureDimension::D2,
        ...
        let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("enative_wgpu::triangle::msaa texture bind group"),
...
impl State {
    pub fn new(device: &wgpu::Device, pipeline: &Pipeline) -> Self {
        let ratio = device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("enative_wgpu::triangle::msaa ratio"),
        ...
        let constants = device.create_bind_group(&wgpu::BindGroupDescriptor {
            label: Some("enative_wgpu::triangle::msaa uniforms bind group"),
    ...
    pub fn render(
        ...
        let mut render_pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
            label: Some("enative_wgpu::triangle::msaa render pass"),
            color_attachments: &[Some(wgpu::RenderPassColorAttachment {
                view: target,
                depth_slice: None,
                resolve_target: None,
