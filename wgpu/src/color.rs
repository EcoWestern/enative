...
pub fn convert(
    ...
    let sampler = device.create_sampler(&wgpu::SamplerDescriptor {
        label: Some("enative_wgpu.offscreen.sampler"),
    ...
    let ratio = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
        label: Some("enative-wgpu::triangle::msaa ratio"),
    ...
    let constant_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
        label: Some("enative_wgpu.offscreen.blit.sampler_layout"),
        entries: &[
    ...
    let constant_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
        label: Some("enative_wgpu.offscreen.sampler.bind_group"),
    ...
    let texture_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
        label: Some("enative_wgpu.offscreen.blit.texture_layout"),
    ...
    let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
        label: Some("enative_wgpu.offscreen.blit.pipeline_layout"),
        bind_group_layouts: &[&constant_layout, &texture_layout],
        immediate_size: 0,
    });

    let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
        label: Some("enative_wgpu.offscreen.blit.shader"),
        source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(include_str!("shader/blit.wgsl"))),
    });

    let pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
        label: Some("enative_wgpu.offscreen.blit.pipeline"),
    ...
    let texture = device.create_texture(&wgpu::TextureDescriptor {
        label: Some("enative_wgpu.offscreen.conversion.source_texture"),
        size: source.size(),
        mip_level_count: 1,
        sample_count: 1,
    ...
    let texture_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
        label: Some("enative_wgpu.offscreen.blit.texture_bind_group"),
    ...
    let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
        label: Some("enative_wgpu.offscreen.blit.render_pass"),
