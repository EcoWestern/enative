...
//! changes slightly.
//!
//! Continuity is tricky in `enative` and the Elm Architecture because
...
//! for `enative`. If you have a list of things, adding an element at the
...
//! continuity. `enative` already does this.
//!
...
/// use enative::widget::keyed_column;
///
/// enum Message {
///     // ...
/// }
